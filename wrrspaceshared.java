	        ...
	        try {
	        	// First step: Initialize the CloudSim package. It should be called
	            	...
	            	vmlist.add(arr1[i]);
                        ...
                        for(int i=0;i<10;i++)
                        {
                            hm.put(vmlist.get(i).getMips()*vmlist.get(i).getNumberOfPes(),vmlist.get(i).getId());
                        }
                        ...
                        //}
                        List<Double> Sorted=new ArrayList<Double>(hm.keySet());
